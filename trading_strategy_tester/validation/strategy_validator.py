...
def validate_strategy_string(strategy_str: str, logs: bool = False) -> (bool, str):
    ...
    try:
        ...
        for kwarg in call.keywords:
            ...
            if kwarg.arg in ['start_date', 'end_date']:
            ...
            if kwarg.arg == 'trade_commissions':
