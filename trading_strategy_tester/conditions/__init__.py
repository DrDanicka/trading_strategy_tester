...
from logical_conditions.if_then_else_condition import IfThenElse
...
from stoploss_takeprofit.stop_loss import StopLoss
from stoploss_takeprofit.take_profit import TakeProfit
