...
class TestBB(unittest.TestCase):
    ...
    def test_bb_lower_close_length_20_SMA_stddev_2_offset_0(self):
        ...
        ], name=f'BBLOWER_{length}_{ma_type.value}_{std_dev}_{offset}').reset_index(drop=True)
        calculated_bb_lower = bb_lower(
    ...
    def test_bb_lower_low_length_9_WMA_stddev_3_offset_1(self):
        ...
        """
        length = 9
        ma_type = SmoothingType.WMA
        std_dev = 3.0
        offset = 1
        source = SourceType.LOW
    ...
    def test_bb_upper_close_length_20_SMA_stddev_2_offset_0(self):
        ...
        ], name=f'BBUPPER_{length}_{ma_type.value}_{std_dev}_{offset}').reset_index(drop=True)
        calculated_bb_upper = bb_upper(
            self.data[source.value],
            length,
            ma_type,
            std_dev,
    ...
    def test_bb_middle_close_length_20_SMA_stddev_2_offset_0(self):
        ...
        ], name=f'BBMIDDLE_{length}_{ma_type.value}_{std_dev}_{offset}').reset_index(drop=True)
        calculated_bb_middle = bb_middle(
            self.data[source.value],
            length,
            ma_type,
            std_dev,
