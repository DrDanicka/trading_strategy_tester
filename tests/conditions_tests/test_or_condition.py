...
class TestOrCondition(unittest.TestCase):
    ...
    def test_to_string(self):
        ...
        expected_string = f'OrCondition(TestCondition({ticker}_TEST_{test_parameter1}), TestCondition({ticker}_TEST_{test_parameter2}), TestCondition({ticker}_TEST_{test_parameter3}))'
        ...
        self.assertEqual(or_condition.to_string(), expected_string)
