...
class TestAndCondition(unittest.TestCase):
    ...
    def test_to_string(self):
        ...
        ticker = 'AAPL'
        test_parameter = random.randint(1, 100)
        expected_string = f'AndCondition(TestCondition({ticker}_TEST_{test_parameter}), TestCondition({ticker}_TEST_{test_parameter}), TestCondition({ticker}_TEST_{test_parameter}))'
        ...
        # Assert
        self.assertEqual(and_condition.to_string(), expected_string)
